...
CORS(app,resources={r"/*": {"origins": ["http://localhost:5173","http://localhost:5174", "https://sakasgas-backend.onrender.com", "https://sakasgas-backend.onrender.com/products/1","https://sakasgas-backend.onrender.com/userLogin","https://bonmaj-3xoo8kq4u-mayars-projects-a7b45ef2.vercel.app","https://bonmaj-backend.onrender.com/orders/<string:id>","https://bonmaj.vercel.app"],"supports_credentials": True,"methods": ["GET", "POST","PATCH", "PUT", "DELETE", "OPTIONS"]}})
