...
CORS(app,resources={r"/*": {"origins": ["http://localhost:5173", "https://bonmaj-backend.onrender.com","https://bonmaj-backend.onrender.com/userLogin","https://bonmaj-backend.onrender.com/orders/*"],"supports_credentials": True,"methods": ["GET", "POST","PATCH", "PUT", "DELETE", "OPTIONS"]}})
